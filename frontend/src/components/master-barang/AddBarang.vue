  ...
  >
    ...
    <a-form layout="vertical" ref="formRef" :model="formData" :rules="rules" @finish="handleSave">
      ...
      <a-form-item label="Tanggal Pengadaan Barang" name="pengadaan">
        <a-date-picker
          v-model:value="formData.pengadaan"
          :format="dateFormat"
          class="w-full"
      ...
      <a-form-item label="Tanggal Pemeliharaan Barang" name="pemeliharaan">
        <a-date-picker
          v-model:value="formData.pemeliharaan"
          :format="dateFormat"
          class="w-full"
          placeholder="Pilih Tanggal Pemeliharaan Barang"
        />
      </a-form-item>
...
const rules = {
  ...
  pengadaan: [
    { required: true, message: "Tanggal pengadaan barang wajib diisi!" },
  ],
  harga: [
    { required: true, message: "Harga barang wajib diisi!" },
