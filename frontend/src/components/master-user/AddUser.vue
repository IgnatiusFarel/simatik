<template>
  ...
  >
    <template #title>
    <h2 class="text-center w-full text-lg font-semibold">Tambah User</h2>
  </template>
    <a-form layout="vertical" ref="formRef"  :model="formData" :rules="rules" hideRequiredMark>
      <a-form-item label="Nomor ID Pengguna" name="id">
        <a-input v-model:value="formData.id" placeholder="Masukkan Nomor ID Pengguna"><template #prefix>#</template></a-input>
      </a-form-item>
      ...
      <a-form-item label="Nama Pengguna" name="nama">
        <a-input v-model:value="formData.nama" placeholder="Masukkan Nama Pengguna" />
      </a-form-item>
      <a-form-item label="Username Pengguna" name="username">
        <a-input v-model:value="formData.username" placeholder="Masukkan Username Pengguna" />
      </a-form-item>
      <a-form-item label="Email Pengguna" name="email">
        <a-input v-model:value="formData.email" placeholder="Masukkan Email Pengguna" />
      </a-form-item>
      <a-form-item label="Password Pengguna" name="password">
        <a-input-password v-model:value="formData.password" placeholder="Masukkan Password Pengguna" />
      </a-form-item>
      <a-form-item label="SKPD Pengguna" name="skpd">
        <a-input v-model:value="formData.skpd" placeholder="Masukkan SKPD Pengguna" />
      </a-form-item>
      <a-form-item label="Role Pengguna" name="role">
        <a-input v-model:value="formData.role" placeholder="Masukkan Role Pengguna" />
      </a-form-item>      
      ...
      <div class="flex justify-center gap-2">
        ...
        <a-button type="primary" @click="handleSave" class="font-semibold" :loading="loading"
            :disabled="loading"> Simpan</a-button>
      </div>  
    </a-form>
  </a-modal>
</template>
